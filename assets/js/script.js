let $forecast = $("#forecast-container");
let cities = JSON.parse(localStorage.getItem("cities")) || ["New York"];
let API_BASE_URL = "https://api.openweathermap.org/data/2.5/";
let API_KEY = "9162cdc11751d103778f3be368b557ac";
let lastCity = "";
